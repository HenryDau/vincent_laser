...
motor_1_setpoint - The setpoint (in degrees) the motor should be at)
motor_2_setpoint - The setpoint (in degrees) the motor should be at)
motor_3_setpoint - The setpoint (in degrees) the motor should be at)
